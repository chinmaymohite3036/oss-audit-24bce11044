...
Inspired by LibreOffice & The Document Foundation        
║" 
║" 
║" 
║" 
...
USER_NAME=$(whoami) 
HOSTNAME=$(hostname) 
DISTRO=$(cat /etc/fedora-release 2>/dev/null || cat /etc/os-release | grep PRETTY_NAME | cu
t -d'"' -f2) 
# ========================================== 
...
echo -e "${YELLOW}💡 TIP: Add this alias to your ~/.bashrc for quick manifesto generation:
${NC}" 
